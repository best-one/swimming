...
public class SSLCommonContext {
    ...
    public static void init(String type,String serverKeyPath,String keyManagerFactory,
                            String clientKeyPath,String sslProto){
     ...
     * @return
     */
    public static KeyManagerFactory serverKeyManagerFactory(String algorithm,String password) throws NoSuchAlgorithmException {
    ...
    public static KeyStore keyStore(String keystoreAlgorithm,String keystorePath,String password) throws Exception {
        ...
        ks.load(new FileInputStream(keystorePath/*"kserver.keystore"*/),
